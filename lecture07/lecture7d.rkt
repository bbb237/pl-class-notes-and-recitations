...
; Our starting point for implementing recursion-via-state as an interpreter.
; this takes our interpreter for boxes from previous lecture and adds if0 and rec (unimplemented)
